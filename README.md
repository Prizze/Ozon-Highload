...
4. Итоговый рейтинг формируется как взвешенная комбинация текстовой релевантности и персонализации: <br>
$Рейтинг = \alpha * текстовая\_релевантность + \beta * релевантность\_к\_пользователю$ <br>
Учитывая, что в поиске все-таки важнее выдавать товары, похожие на запрос, то примем:
$\alpha = 0.8,\ \beta = 0.2$
